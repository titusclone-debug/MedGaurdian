...
app.include_router(nabh_ontology.router, prefix="/api/nabh/ontology", tags=["NABH Compliance Ontology"], dependencies=protected_dependencies)
app.include_router(nabh_profile.router, prefix="/api/nabh/profile", tags=["NABH Compliance Profile"], dependencies=protected_dependencies)
