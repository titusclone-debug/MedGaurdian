...
from app.models.database import (
    NABHRequirementCitation, NABHSourceDocument, NABHMeasurableElement,
    NABHObjectiveElement, NABHStandard, NABHChapter
)

def _map_citation_to_dict(citation: NABHRequirementCitation, doc: Optional[NABHSourceDocument],
                           meas_element: NABHMeasurableElement, obj_element: NABHObjectiveElement,
    ...
    return {
        ...
        "ontology": {
            ...
            "objective_element_code": obj_element.canonical_code,
            "objective_element_description": obj_element.description,
            "measurable_element_code": meas_element.canonical_code,
            "measurable_element_description": meas_element.description
        }
    }
...
class CitationService:
    ...
    def get_citations_for_measurable_element(db: Session, element_id: str) -> List[Dict[str, Any]]:
        ...
        results = db.query(
            ...
            NABHMeasurableElement, NABHRequirementCitation.measurable_element_id == NABHMeasurableElement.id
        ).join(
            ...
            NABHRequirementCitation.measurable_element_id == element_id
        ).all()
        
        return [
            _map_citation_to_dict(cit, doc, meas, obj, std, chap)
            for cit, doc, meas, obj, std, chap in results
        ]
    ...
    def get_citation_by_id(db: Session, citation_id: str) -> Optional[Dict[str, Any]]:
        ...
        cit, doc, meas, obj, std, chap = result
        return _map_citation_to_dict(cit, doc, meas, obj, std, chap)
    ...
    def format_citation_string(citation: Dict[str, Any]) -> str:
        ...
        meas_code = ontology.get("measurable_element_code", "N/A")
