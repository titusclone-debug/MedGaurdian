...
import { apiFetch, getStoredUser } from '../features/nabh/api'
import type {
  Coverage,
  EvidencePlan,
  EvidencePlanItem,
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/40" onMouseDown={onClose}>
      <aside
        role="dialog"
        aria-modal="true"
        aria-labelledby="requirement-explanation-title"
        className="h-full w-full max-w-3xl overflow-y-auto bg-white shadow-xl"
        onMouseDown={(event) => event.stopPropagation()}
      >
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-5 py-4">
          <div>
            <h3 id="requirement-explanation-title" className="text-lg font-bold text-slate-900">Requirement Explanation</h3>
